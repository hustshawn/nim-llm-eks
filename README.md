...
## Setup
1. Configure the NGC API Key. You can retrieve it the [from NVIDIA](https://docs.nvidia.com/ai-enterprise/deployment-guide-spark-rapids-accelerator/0.1.0/appendix-ngc.html).
...
It will take around 20 mins to get everything up.

3. Check the status, run
